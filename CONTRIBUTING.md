...
5. Do not add content that is out of scope for the CKA exam domains.

## Reporting Issues

Open an issue on GitHub: [github.com/techiescamp/cka-certification-guide/issues](https://github.com/techiescamp/cka-certification-guide/issues)
