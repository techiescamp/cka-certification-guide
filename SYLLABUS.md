...
Each exam domain has a dedicated study guide with core concepts.

- 🏗️ **[Domain 1: Cluster Architecture, Installation & Configuration](./study-notes/01-cluster-architecture.md)** (25%)
- 📦 **[Domain 2: Workloads & Scheduling](./study-notes/02-workloads-scheduling.md)** (15%)
