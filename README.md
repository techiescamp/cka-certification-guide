...
> <span style="color:white;">Troubleshooting Clusters</span> : When draining a node, use --ignore-daemonsets to safely move workloads that can be moved while ignoring daemonsets.
